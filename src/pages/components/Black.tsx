  ...
  return (
    <div className={spaceGrotesk.className}>
        <div className='flex max-w-[90%] m-auto bg-[#191A23] py-[70px] px-[60px] rounded-[45px] mb-[140px]'>
            <div className='font-normal text-[#FFFFFF] text-[18px] ml-[64px] relative before:content-[""] before:absolute before:top-0 before:right-0 before:w-[1px] before:h-45 before:bg-amber-50'><p>For a local restaurant, we implemented a targeted PPC campaign that resulted in a 50% increase in website traffic and a 25% increase in sales.</p><div className='font-normal text-[20px] leading-[28px] text-[#B9FF66] mt-5'><span>Learn more</span><ArrowOutwardIcon/></div></div>
